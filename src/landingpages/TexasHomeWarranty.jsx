...
const TexasHomeWarranty =()=>{
    return(
        <>
        <Helmet>
            <title>Texas Resources - Acclaimed Home Warranty : Acclaimed Home Warranty</title>
            <meta name="description" content="Texas Resources - Acclaimed Home Warranty" />
        </Helmet>
...
export default TexasHomeWarranty;