...
const IdahoHomeWarranty = () => {
    return (
        <>
            <Helmet>
                <title>Idaho Resources - Acclaimed Home Warranty : Acclaimed Home Warranty</title>
                <meta name="description" content="Idaho Resources - Acclaimed Home Warranty" />
            </Helmet>
...
export default IdahoHomeWarranty;