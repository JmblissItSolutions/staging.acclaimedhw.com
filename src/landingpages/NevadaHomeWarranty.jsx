...
const NevadaHomeWarranty =()=>{
    return(
        <>
        <Helmet>
            <title>Nevada Resources - Acclaimed Home Warranty : Acclaimed Home Warranty</title>
            <meta name="description" content="Nevada Resources - Acclaimed Home Warranty" />
        </Helmet>
...
export default NevadaHomeWarranty;