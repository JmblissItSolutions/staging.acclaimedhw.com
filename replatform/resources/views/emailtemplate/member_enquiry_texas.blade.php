...
<table>
    ...
    <tr><th style="text-align:left">Email : </th><td>{{$email_4}}</td></tr>
    <tr><th style="text-align:left">Phone Number : </th><td>{{$phone_number_4}}</td></tr>
    <tr><th style="text-align:left">Information Message : </th><td>{{$information_4}}</td></tr>
